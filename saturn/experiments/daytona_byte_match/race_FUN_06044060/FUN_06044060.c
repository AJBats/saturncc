...
/* Per-function pragmas (noregsave, noregalloc, sh_alloc_lowfirst)
 * live immediately above each function's signature. See
 * saturn/workstreams/save_strategy_and_asm_intrinsic.md for the
 * tagging strategy and known-hard-case notes. */
